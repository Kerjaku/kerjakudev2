        ...
        return (
            <>
                ...
                <div class="module-text" id="moduleonetext">
                    Setelah memahami bahwa visi sangat krusial sebagai langkah awal membangun sukses, maka pemuda harus memahami cara-cara merumuskan visi personalnya dengan jelas.
                    <br /><br />
                    <span style={{ color: "#40A26E", fontWeight: 'bold' }}>Langkah-langkah yang bisa dilakukan pemuda untuk menetapkan visinya adalah:</span>
                    <ol>
                        <li>
                            ...
                            <ul>
                                ...
                                <br /><br />
                                <span style={{ backgroundColor: "#f1f3be", fontWeight: 'bold' }}>Contoh:</span>
                                <br /><br />
                        ...
                        <li>
                            ...
                            <ul>
                                <span style={{ color: "#068238" }}>Pilih bidang/sektor</span> yang sesuai dengan rumusan anda.
                                <br /><br />
                                <span style={{ color: "#068238" }}>Pilih peran</span> akan anda lakukan pada bidang tersebut.
                                <br /><br />
                                Tuliskan <span style={{ color: "#068238" }}>tujuan</span> secara spesifik
                            </ul>
                            <br /><br />
                            <span style={{ backgroundColor: "#f1f3be", fontWeight: 'bold' }}>Contoh:</span>
                            <br />
                            <ul>
                                <span style={{ color: "#068238" }}>Sektor dipilih:</span> Kuliner<br /><br />
                                <span style={{ color: "#068238" }}>Peran:</span> Pemilik dan pengelola<br /><br />
                                <span style={{ color: "#068238" }}>Tujuan:</span> Memiliki usaha kuliner roti dan kue kering
                            </ul>
                        </li>
                        <br /><br />
                        <li>
                        ...
                        <li>
                            ...
                            <br /><br />
                            <b>Tuliskan pernyataan visi, contoh:</b>
                            <br /><br />
                            <span style={{ color: "#068238" }}>“Menjadi pengusaha roti dan kue kering di tahun 2021, agar bisa memiliki penghasilan sendiri dan tidak bergantung dengan keluarga”</span>
                            <br /><br />
                            <b>Identifikasi kebutuhan yang terpikirkan saat ini, dimana hal tersebut menjadi kualifikasi atau kondisi yang mampu mendukung visi, contoh:</b>
                            <br /><br />
                            <span style={{ color: "#068238" }}>Kondisi yang dibutuhkan:</span>
                            <i>
                                <br /><br />
                                1. Menguasasi cara pembuatan roti ulang tahun, bolu black forest dan bolu marmer
                                <br />2. Menguasai cara pembuatan kue kering: nastaart, kue kacang, croissant
                                <br /> 3. Memiliki alat pembuatan roti dan kue kering
                                <br /> 4. Memiliki tempat untuk produksi dan berjualan
